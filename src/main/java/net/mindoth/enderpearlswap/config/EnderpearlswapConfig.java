...
public class EnderPearlSwapConfig {
    ...
    static {
        ...
        LANDING_AREA_DISTANCE = BUILDER.comment("How far in blocks do entities need to be from the pearl to be teleported (Default = 2.0)")
                .define("Distance from pearl", 2.0);
